        ...
        >
          <div className="grid grid-cols-12 p-10">
            ...
            <div className="xs:col-span-11 md:col-span-9 xl:col-span-9    rounded-xl grid grid-cols-12 ">
              ...
              <div className="xs:col-span-11 sm:col-span-10 md:col-span-8 xs:mt-24 md:mt-0  xl:col-span-6 w-full xs:bg-white xs:bg-opacity-75 xs:text-opacity-75 md:bg-[#FFF] rounded-xl  xs:h-[420px] md:h-[460px]  xl:h-[470px]   xs:p-5 sm:p-10 sm:mr-5">
