        ...
        >
          <div className="grid grid-cols-12 p-10">
            ...
            <div className="xs:col-span-11 md:col-span-9 xl:col-span-9    rounded-xl grid grid-cols-12 ">
              ...
              <div className="xs:col-span-11 sm:col-span-10 md:col-span-8 xs:mt-24 md:mt-0  xl:col-span-6 w-full xs:bg-white xs:bg-opacity-75 xs:text-opacity-75 md:bg-[#FFF] rounded-xl  xs:h-[410px] md:h-[450px] xl:h-[460px]   xs:p-5 sm:p-10 sm:mr-5">
                ...
                <div className="lg:col-span-8 mt-5 text-center xs:mt-3 md:mt-0 xs:text-2xl md:text-3xl lg:text-3xl   font-medium text-black">
                  Sign In
                </div>
                <div className="md:col-span-8 hidden text-red-600 text-center xs:mt-5 md:ml-5 ">
                  Error Message
                </div>
